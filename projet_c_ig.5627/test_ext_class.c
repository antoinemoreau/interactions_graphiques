...
// handle_buttonpress_on_testclass --

ei_bool_t handle_buttonpress_on_testclass	(ei_widget_t*		widget,
						 struct ei_event_t*	event,
						 void*			user_param)
{
	printf("pressed mouse button on a testclass widget.\n");
	return EI_TRUE;
}
...
int ei_main(int argc, char** argv)
{
	...
	// Check that picking works: do a binding.
	ei_bind(ei_ev_mouse_buttondown, test, NULL, handle_buttonpress_on_testclass, NULL);
